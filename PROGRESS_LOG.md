...
## 2026-07-10 — 🔜 Phase 3 (Community Configs SHARING) — steps 1+2 DEVICE-VERIFIED, on `feat/config-export`

> **Branch `feat/config-export` off main `d0284651` (post-2.5.2). NOT merged. All `2.6-preN` (vc43+). The "share your own configs" half committed to in the 2.5.2 release notes.**
